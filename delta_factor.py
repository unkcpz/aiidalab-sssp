...
class ComputeDeltaFactorWidget(ipw.VBox):
    ...
    def __init__(self, **kwargs):
        ...
        self.ecutwfc = ipw.BoundedIntText(
            value=200,
            min=10,
            max=300,
            step=1,
        ...
        self.ecutrho = ipw.BoundedIntText(
            value=800,
            min=10,
            max=10000,
            step=1,
        ...
        self.scale_count = ipw.BoundedIntText(
            value=7,
            min=3,
            max=20,
            step=1,
        ...
        self.scale_increment = ipw.FloatText(
            value=0.02, description="EOS scale increment:", disabled=False, **extra
        )
        self.smearing_type = ipw.Dropdown(
            options=[
                "gaussian",
                "methfessel-paxton",
                "marzari-vanderbilt",
        ...
        self.smearing = ipw.FloatText(
            value=0.00735, description="smearing width:", disabled=False, **extra
        )
    ...
    def submit(self):
        ...
        if self.input_pseudo is None:
            ...
            if self.protocol.value != "None":
                ...
                builder.parameters.scale_count = orm.Int(self.scale_count.value)
