...
def eos_birch_murnaghan(volume, E0, V0, B0, B1):
    ...
    E = E0 + 9.0 * B0 * V0 / 16.0 * (eta - 1.0) ** 2 * (
        6.0 + B1 * (eta - 1.0) - 4.0 * eta
    )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        with out:
            ...
            y_wien2k = eos_birch_murnaghan(
                x, energy0, V0_wien2k, B0_wien2k / 160.2176487, B1_wien2k
            )
            ...
            plt.circle(
                volumes, energies, fill_color=self._RES_COLOR, size=self._CIRCLE_SIZE
            )

            text = Label(
                x=self._PLOT_WIDTH / 2,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        with out:
            ...
            plt.line(
                x_data, y_data, line_width=self._LINE_WIDTH, line_color=self._RES_COLOR
            )
            plt.square(
